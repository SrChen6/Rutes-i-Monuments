...
On the same folder of the programs are attached some example files of what the program does. These are:
- `Girona.csv` : A file to save the information of the points downloaded.
- `Girona_points.png`: A visualization of all the points downloaded.
- `Girona.png` : It contains all the routes generated after the clustering.
- `Girona.kml` : The file that can be uploaded to [Google Earth](https://www.google.es/intl/es/earth/index.html).
- `Girona_monuments.png` : It contains the shortest routes to nearby monuments.
- `Girona_monuments.kml` : Same as `Girona.kml`. It can be uploaded to [Google Earth](https://www.google.es/intl/es/earth/index.html) to view the shortest routes to nearby monuments.

Apart from `monuments.csv` and `requirements.txt`, all the other files are only used for `README.md`, and the program will not generate any copy or variation of them.
...
<img src="terminal1.png" alt="Termianl1" width="400"/>
...
<img src="Girona.png" alt="Girona PNG" width="500"/>

Image of the routes generated on Girona. Made with [staticmap](https://developers.google.com/maps/documentation/maps-static/overview?hl=es-419).
<img src="Girona_KML_example.png" alt="Girona KML" width="500"/>

Image of the routes generated on Giona. Extracted from [Google Earth](https://www.google.es/intl/es/earth/index.html).
...
For this, a file called `monuments.csv` has to be downloaded. In case the user accidentally deletes it, the program will automatically redownload the file.
...
<img src="Girona_monuments.png" alt="Girona Monuments" width="500"/>

Image of the shortest routes to nearby monuments. Made with [staticmap](https://developers.google.com/maps/documentation/maps-static/overview?hl=es-419).
